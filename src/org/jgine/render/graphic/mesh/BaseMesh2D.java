...
public class BaseMesh2D implements AutoCloseable {
	...
	public BaseMesh2D(float[] vertices) {
		this("", vertices, null);
	}

	public BaseMesh2D(String name, float[] vertices) {
		this("", vertices, null);
	}

	public BaseMesh2D(float[] vertices, @Nullable float[] textureChords) {
		this("", vertices, textureChords);
	}

	public BaseMesh2D(String name, float[] vertices, @Nullable float[] textureChords) {
		this.name = name;
