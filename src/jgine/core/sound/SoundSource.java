...
import jgine.core.sound.effect.SoundEffect;
import jgine.core.sound.effect.SoundFilter;
import jgine.utils.Options;
import jgine.utils.collection.list.PersistentArrayList;
...
public class SoundSource {
	...
	void play() {
		if (!isPlaying() && SoundManager.SOURCES.size() < Options.MAX_SOUNDS.asInt()) {
			if (isStream()) {
