...
/**
 * Helper class for benchmarking per identifier in nanoseconds. Tracks test
 * count and current, average, best, worst time in nanoseconds.
 */
public class Benchmark {
	...
	/**
	 * Container for {@link Benchmark} data. Tracks test count and current, average,
	 * best, worst time in nanoseconds.
	 */
	public static class BenchmarkData {
		...
		public String toString() {
			return "Benchmark [count=" + count + ", current=" + current + ", average=" + getAverage() + ", best=" + best
					+ ", worst=" + worst + "]";
		}
	}
}
