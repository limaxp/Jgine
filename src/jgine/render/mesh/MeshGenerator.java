...
import jgine.render.text.TrueTypeFontGenerated;
...
public class MeshGenerator {
	...
	public static BaseMesh text(BitmapFont font, int size, String text, float xOffset, float yOffset) {
		try (MemoryStack stack = stackPush()) {
			...
			Vector2f contentScale = DisplayManager.getDisplay(Options.MONITOR.asInt()).getContentScale();
