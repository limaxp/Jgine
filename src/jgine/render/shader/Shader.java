...
public class Shader {
	...
	public final void setUniformRGB(int uniform, int color) {
		glUniform3f(uniform, Color.red_(color), Color.green_(color), Color.blue_(color));
	}

	public final void setUniformRGBA(int uniform, int color) {
		glUniform4f(uniform, Color.red_(color), Color.green_(color), Color.blue_(color), Color.alpha_(color));
	}
