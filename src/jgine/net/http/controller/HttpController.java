package jgine.net.http.controller;
...
import jgine.net.http.annotation.Parameter;
import jgine.net.http.annotation.Route;
import jgine.net.http.annotation.Routes;
...
public abstract class HttpController {
	...
	public static class RouteEntry {
		...
		public RouteEntry(Method method) {
			this.method = method;
			if (method.isAnnotationPresent(jgine.net.http.annotation.Method.class))
				this.htmlMethod = method.getAnnotation(jgine.net.http.annotation.Method.class).value();
			else
				this.htmlMethod = "GET";
